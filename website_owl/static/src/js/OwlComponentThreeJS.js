odoo.define("website_owl.owl_component_threejs", async function (require) {
  "use strict";
  const Slider = require("website_owl.owl_component_slider");
  const { Component } = owl;
  ...
  class OwlThreeJS extends Component {
    ...
    setup() {
      ...
      this.z = 0.01;
      this.x = 0.01;
      this.env.bus.on("add_mesh", null, this._add_mesh.bind(this));
    }
    async willStart() {
